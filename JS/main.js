...
gsap.timeline()
    ...
    .from(janouImage.firstElementChild, 2, { scale: 1.6, ease: "power3.easeOut" }, .2)
    .from(hertzImage, 1.4, { x: "80vh", opacity: 1, ease: "power3.easeOut" }, .2)
    .from(hertzImage.lastElementChild, 2, { scale: 1.8, ease: "power3.out" }, .2)
...
tl.staggerFrom([headlineFirst.children, headlineSecond.children, headlineThird.children],
    1,
    {
        y: 60,
        opacity: 0,
